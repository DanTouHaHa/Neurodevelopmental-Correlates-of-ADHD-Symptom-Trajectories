...
data_X=data[["cov_interview_age", "cov_demo_sex_v2", "cov_demo_comb_income_v2", "cov_demo_prnt_ed_v2", 
...
data_X_less=data[["cov_interview_age", "cov_demo_sex_v2", "cov_demo_comb_income_v2", "cov_demo_prnt_ed_v2", 
...
result.to_excel("ABCD ADHD_Hyperactivity Model0 SVR trajectory prediction FU3.xlsx", index=False)  
