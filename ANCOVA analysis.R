setwd("/Users/hwj/Documents/E/Fudan_Luoqiang_ABCD_V5_Project/A_Trajectory/20240509_DataAnalysis")
library(readr)
library(tidyverse)
library(readxl)
library(writexl)
...
write.csv(output,"/Users/hwj/Documents/E/Fudan_Luoqiang_ABCD_V5_Project/A_Trajectory/20240509_DataResult_Behavioral/四组ANCOVA_result_Personality_delta-y.csv" )
...
output <- t(output)
output <- as.data.frame(output)
write.csv(output,"/Users/hwj/Documents/E/Fudan_Luoqiang_ABCD_V5_Project/A_Trajectory/20240509_DataResult_sMRI/四组ANCOVA_result_Thick_delta-y.csv" )
